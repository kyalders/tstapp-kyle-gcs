...
provider "registry.terraform.io/hashicorp/google" {
  version     = "3.90.1"
  constraints = ">= 2.12.0, >= 3.0.0, ~> 3.45, < 4.0.0, < 5.0.0"
  hashes = [
    "h1:6F47/VTANFXmlvnXrQgfW/jzu59B30FeZ+wgFXmF4OM=",
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "3.90.1"
  constraints = ">= 3.0.0, ~> 3.45, < 5.0.0"
  hashes = [
    "h1:N2JN2YBWFp8en0Y7QLo4PvVnWkwm4hHKVGrTqOUa+ek=",
